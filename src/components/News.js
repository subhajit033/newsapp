...
export class News extends Component {
    ...
    handlePrevClick = async () => {
        if (this.state.page - 1 < 1) {
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5ff9696d98d945c49e3fe42468d0dd32&page=${this.state.page - 1}&pageSize=6`;
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5ff9696d98d945c49e3fe42468d0dd32&page=${this.state.page}&pageSize=6`;
        this.setState({loading: true})
        let data = await fetch(url);
        let parseData = await data.json();
        ...
        return (
            <>
                 <div className='container my-4'>
                    <h3 className='text-center mb-3'>Top HeadLines</h3>
